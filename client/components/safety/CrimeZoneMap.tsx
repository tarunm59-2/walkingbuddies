import { AlertTriangle, Shield, MapPin, TrendingUp, TrendingDown } from "lucide-react";
    ...
    <div className="rounded-xl bg-white/80 backdrop-blur-sm border border-slate-200 shadow-sm">
      <div className="p-6 border-b border-slate-200">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-slate-900">Crime Safety Map</h3>
            <p className="text-sm text-slate-600 mt-1">Real-time crime data by zipcode</p>
          </div>
      ...
      <div className="p-6">
        ...
        <div className="relative h-80 rounded-lg bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 overflow-hidden mb-6">
          ...
          <div className="absolute inset-0 opacity-20">
            <svg width="100%" height="100%" className="h-full w-full">
              <defs>
                <pattern id="crime-grid" width="20" height="20" patternUnits="userSpaceOnUse">
            ...
            >
              ...
              <div className={cn(
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="font-bold text-white text-sm">{zone.crimeGrade}</span>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Legend */}
          <div>
            <h4 className="text-sm font-semibold text-slate-900 mb-3">Safety Grades</h4>
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-slate-600">B - Caution Advised</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full bg-zone-danger"></div>
                <span className="text-sm text-slate-600">C/D/F - High Risk</span>
              </div>
            </div>
          </div>
          ...
          {/* Quick stats */}
          <div>
            <h4 className="text-sm font-semibold text-slate-900 mb-3">Area Summary</h4>
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                <span className="text-slate-600">Safest Area:</span>
                <span className="font-medium text-green-700">Financial District (A+)</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-slate-600">Avoid Area:</span>
                <span className="font-medium text-red-700">East Village (C)</span>
              </div>
              <div className="flex items-center justify-between text-sm">
